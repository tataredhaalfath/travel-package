    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('travel-package.create') }}" class="btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-plus fa-sm text-white-50"></i>Tambah Paket <i class="ri-travesti-line"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('travel-package.destroy', $item->id) }}" method="post"
                                            ...
                                            @csrf
                                            @method('delete')
                                            <button class="btn btn-danger" onclick="return confirm('Hapus Data?')"><i

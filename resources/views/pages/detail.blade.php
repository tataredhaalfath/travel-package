                        ...
                        <div class="card card-details">
                            ...
                            <div class="features">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 border-left">
                                        <div class="description">
                                            <img src="{{ url('frontend/images/ic_food.png') }}" alt=""
                                                class="features-image">
                                            <div class="description">
                                                <h3>Foods</h3>
                                                <p>{{ $item->foods }}</p>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <div class="members my-2">
                                <img src="{{ url('frontend/images/member1.png') }}" class="member-images mr- mb-1"
                                    alt="member-images">
                                <img src="{{ url('frontend/images/member2.png') }}" class="member-images mr- mb-1"
                                    alt="member-images">
                                <img src="{{ url('frontend/images/member3.png') }}" class="member-images mr- mb-1"
                                    alt="member-images">
                                <img src="{{ url('frontend/images/member4.png') }}" class="member-images mr- mb-1"
                                    alt="member-images">
                                <img src="{{ url('frontend/images/member5.png') }}" class="member-images mr- mb-1"
                                    alt="member-images">
                            ...
                            <table class="trip-information">
                                <tr>
                                    <th width="50%">Date of Departur</th>
                                    <td width="50%" class="text-right">
                                        {{ \Carbon\Carbon::create($item->departur_date)->format('F n, Y') }}
                                    </td>
                                </tr>
                                <tr>
